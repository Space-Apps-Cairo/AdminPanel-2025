...
export const bootcampDetailsApi = api.injectEndpoints({
    ...
    endpoints: (builder) => ({
        ...
        addBootcampDetails: builder.mutation<SingleBootcampDetailsResponse, BootcampDetailsRequest>({
            query: (newBootcamp) => ({
                url: "/BootcampDetails",
                method: "POST",
                body: newBootcamp,
        ...
        deleteBootcampDetails: builder.mutation<SingleBootcampDetailsResponse, string | number>({
            query: (id) => ({
                url: `/BootcampDetails/${id}`,
                method: "DELETE",
            }),
